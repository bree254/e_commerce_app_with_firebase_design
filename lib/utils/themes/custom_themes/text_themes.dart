...
class MyTextTheme{
  ...
  static TextTheme lightTextTheme= TextTheme(
    ...
    bodyLarge: TextStyle().copyWith(fontSize: 14,fontWeight: FontWeight.w600,color: Colors.black),
    ...
    labelMedium: TextStyle().copyWith(fontSize: 12,fontWeight: FontWeight.w500,color: Colors.black.withOpacity(0.5)),
  ...
  static TextTheme darkTextTheme= TextTheme(
    ...
    bodyLarge: TextStyle().copyWith(fontSize: 14,fontWeight: FontWeight.w600,color: Colors.white),
    ...
    labelMedium: TextStyle().copyWith(fontSize: 12,fontWeight: FontWeight.w500,color: Colors.white.withOpacity(0.5)),
